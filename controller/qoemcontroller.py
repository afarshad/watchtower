...
"""qoemcontroller.py: Qoem Controller - allows a user to control any number of Qoem nodes."""
...
class Controller():
    ...
    def _create_config_defaults(self):
        ...
        config['log_path'] = '/var/log/qoem/controller'
    ...
    def _exit_controller(self, signal, frame):
        """Quit the qoem controller gracefully"""
        self._api.stop()
        self._state.stop()
        self._request_handling.stop()
        self._notification.stop()
        self.print_info(TAG, 'Caught exit signal: exiting qoem controller')
        os._exit(0)
    ...
    def _add_to_total (self, result, total_result):
        ...
        # TODO change the function to be meaningful for the QoEM Stats
